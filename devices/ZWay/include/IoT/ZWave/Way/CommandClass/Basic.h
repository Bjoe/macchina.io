...
#ifndef IOT_ZWAVE_WAY_COMMANDCLASS_BASIC_H
#define IOT_ZWAVE_WAY_COMMANDCLASS_BASIC_H
...
{
public:
	Basic(Controller::Ptr controller);
...
#endif // IOT_ZWAVE_WAY_COMMANDCLASS_BASIC_H
